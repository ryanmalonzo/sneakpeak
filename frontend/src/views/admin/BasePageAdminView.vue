...
<template>
    <section class="flex h-screen">
        <!-- sidebar -->
        <nav :class="{'flex': isSidebarOpen, 'hidden': !isSidebarOpen, 'fixed left-0 top-0 h-screen': isSidebarOpen && isMobile}" class="md:flex md:w-[15.625rem] p-5 flex-col items-center gap-[6.25rem] flex-shrink-0 bg-black bg-opacity-95">
            ...
            <div class="mt-8">
                ...
                <svg v-else xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 14 14" fill="none" @click="toggleSidebar">
        ...
        <section class="flex-grow p-6">
            ...
            <nav class="flex justify-end gap-4 mb-2">
                ...
                <div class="md:hidden fixed top-4 left-2 p-4">
                    <svg v-if="isMobile && !isSidebarOpen" @click="toggleSidebar" xmlns="http://www.w3.org/2000/svg" width="14" height="10" viewBox="0 0 14 10" fill="none" class="cursor-pointer">
