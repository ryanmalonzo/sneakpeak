        ...
        <ul>
          <li>
            <a href="" class="flex gap-4 rounded-xl p-4 hover:bg-sky-700">
              ...
              >
                <path
                  d="M9 21.5V15.5C9 14.9696 9.21071 14.4609 9.58579 14.0858C9.96086 13.7107 10.4696 13.5 11 13.5H13C13.5304 13.5 14.0391 13.7107 14.4142 14.0858C14.7893 14.4609 15 14.9696 15 15.5V21.5M5 12.5H3L12 3.5L21 12.5H19V19.5C19 20.0304 18.7893 20.5391 18.4142 20.9142C18.0391 21.2893 17.5304 21.5 17 21.5H7C6.46957 21.5 5.96086 21.2893 5.58579 20.9142C5.21071 20.5391 5 20.0304 5 19.5V12.5Z"
                  stroke="#EFEFEF"
                  stroke-width="2"
            ...
            <a href="" class="flex gap-4 rounded-xl p-4 hover:bg-sky-700">
              <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 14 14" fill="none">
                <g clip-path="url(#clip0_156_4525)">
                  <path fill-rule="evenodd" clip-rule="evenodd" d="M0.6 0.399994C0.268629 0.399994 0 0.668623 0 0.999994C0 1.33136 0.268629 1.59999 0.6 1.59999H1.69925L3.20968 9.90732C3.26155 10.1926 3.51003 10.4 3.8 10.4H11.8C12.0753 10.4 12.3153 10.2126 12.3821 9.94551L13.9821 3.54551C14.0269 3.36627 13.9866 3.17638 13.8729 3.03075C13.7592 2.88512 13.5848 2.79999 13.4 2.79999H3.13711L2.79032 0.892662C2.73845 0.607368 2.48997 0.399994 2.2 0.399994H0.6ZM4.30074 9.19999L3.35529 3.99999H12.6315L11.3315 9.19999H4.30074ZM7.91201 4.39999C8.24338 4.39999 8.51201 4.66862 8.51201 4.99999V5.99999H9.51201C9.84338 5.99999 10.112 6.26862 10.112 6.59999C10.112 6.93136 9.84338 7.19999 9.51201 7.19999H8.51201V8.19999C8.51201 8.53136 8.24338 8.79999 7.91201 8.79999C7.58064 8.79999 7.31201 8.53136 7.31201 8.19999V7.19999H6.31201C5.98064 7.19999 5.71201 6.93136 5.71201 6.59999C5.71201 6.26862 5.98064 5.99999 6.31201 5.99999H7.31201V4.99999C7.31201 4.66862 7.58064 4.39999 7.91201 4.39999ZM5.2 11.2C4.53726 11.2 4 11.7372 4 12.4C4 13.0627 4.53726 13.6 5.2 13.6C5.86274 13.6 6.4 13.0627 6.4 12.4C6.4 11.7372 5.86274 11.2 5.2 11.2ZM9.2 12.4C9.2 11.7372 9.73725 11.2 10.4 11.2C11.0627 11.2 11.6 11.7372 11.6 12.4C11.6 13.0627 11.0627 13.6 10.4 13.6C9.73725 13.6 9.2 13.0627 9.2 12.4Z" fill="white"/>
                </g>
                <defs>
          ...
          <li>
            <a href="" class="flex gap-4 rounded-xl p-4 hover:bg-sky-700">
              <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" viewBox="0 0 12 14" fill="none">
                <path fill-rule="evenodd" clip-rule="evenodd" d="M3 1.2C2.45137 1.2 2 1.65137 2 2.2V12.2517L5.65736 9.70746C5.86332 9.56418 6.13668 9.56418 6.34264 9.70746L10 12.2517V2.2C10 1.65137 9.54863 1.2 9 1.2H3ZM0.800001 2.2C0.800001 0.988629 1.78863 0 3 0H9C10.2114 0 11.2 0.988629 11.2 2.2V13.4C11.2 13.6234 11.0759 13.8283 10.8779 13.9318C10.6799 14.0352 10.4408 14.0201 10.2574 13.8925L6 10.9309L1.74264 13.8925C1.55924 14.0201 1.32015 14.0352 1.12214 13.9318C0.924128 13.8283 0.800001 13.6234 0.800001 13.4V2.2Z" fill="white"/>
              </svg>
              Catégories
            </a>
          </li>
            ...
            <a href="" class="flex gap-4 rounded-xl p-4 hover:bg-sky-700">
              <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" viewBox="0 0 14 14" fill="none">
                <g clip-path="url(#clip0_156_4716)">
                  <path d="M10.9728 13.6728C10.8811 13.6728 10.7902 13.6514 10.7062 13.6071L7.00032 11.6586L3.29447 13.6071C3.10192 13.7087 2.86734 13.6911 2.69084 13.5635C2.51433 13.4352 2.4257 13.2182 2.46314 13.0027L3.17069 8.87658L0.173151 5.95469C0.0165115 5.80264 -0.039267 5.57417 0.0279732 5.3671C0.0952134 5.16004 0.274776 5.00875 0.49025 4.97742L4.63316 4.37531L6.48609 0.62056C6.67864 0.229345 7.32124 0.229345 7.51379 0.62056L9.36672 4.37531L13.5096 4.97742C13.7251 5.00875 13.9047 5.16004 13.9719 5.3671C14.0391 5.57417 13.9834 5.80264 13.8267 5.95469L10.8292 8.87658L11.5367 13.0027C11.5734 13.2182 11.4855 13.4352 11.309 13.5635C11.2097 13.6361 11.0913 13.6728 10.9728 13.6728ZM7.00032 10.4384C7.09201 10.4384 7.1837 10.4605 7.26699 10.5041L10.2118 12.0522L9.64943 8.77343C9.61734 8.58699 9.67923 8.3975 9.81447 8.26607L12.1962 5.944L8.90368 5.46567C8.71724 5.43817 8.55525 5.32126 8.47273 5.15239L7.00032 2.16938L5.52791 5.15239C5.44463 5.32126 5.2834 5.43893 5.09697 5.46567L1.80449 5.944L4.18617 8.26607C4.32141 8.3975 4.38254 8.58699 4.35121 8.77343L3.78884 12.0522L6.73365 10.5041C6.8177 10.4605 6.90939 10.4384 7.00032 10.4384Z" fill="white"/>
                </g>
                <defs>
          ...
          <li>
            <a href="" class="flex gap-4 rounded-xl p-4 hover:bg-sky-700">
              ...
              >
                ...
                />
                <path
                  d="M9 12.5C9 13.2956 9.31607 14.0587 9.87868 14.6213C10.4413 15.1839 11.2044 15.5 12 15.5C12.7956 15.5 13.5587 15.1839 14.1213 14.6213C14.6839 14.0587 15 13.2956 15 12.5C15 11.7044 14.6839 10.9413 14.1213 10.3787C13.5587 9.81607 12.7956 9.5 12 9.5C11.2044 9.5 10.4413 9.81607 9.87868 10.3787C9.31607 10.9413 9 11.7044 9 12.5Z"
                  stroke="#EFEFEF"
                  stroke-width="2"
                  stroke-linecap="round"
                  stroke-linejoin="round"
