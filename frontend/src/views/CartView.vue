...
<template>
    <BasePage>
        <div class="p-20 gap-24 flex flex-row self-stretch items-start">



            <div class="flex-col flex gap-16 flex-1 items-start"> <!-- left -->
            ...
            <div class="flex flex-col items-start gap-5"> <!-- right -->
